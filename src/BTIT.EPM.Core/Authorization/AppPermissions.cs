namespace BTIT.EPM.Authorization
{
    ...
    {
        public const string Pages_FileSignatures = "Pages.FileSignatures";
        public const string Pages_FileSignatures_Create = "Pages.FileSignatures.Create";
        public const string Pages_FileSignatures_Edit = "Pages.FileSignatures.Edit";
        public const string Pages_FileSignatures_Delete = "Pages.FileSignatures.Delete";
        ...
        public const string Pages_Recipients = "Pages.Recipients";
        public const string Pages_Recipients_Create = "Pages.Recipients.Create";
        public const string Pages_Recipients_Edit = "Pages.Recipients.Edit";
        public const string Pages_Recipients_Delete = "Pages.Recipients.Delete";
        ...
        public const string Pages_DocumentRequestAuditTrails = "Pages.DocumentRequestAuditTrails";
        public const string Pages_DocumentRequestAuditTrails_Create = "Pages.DocumentRequestAuditTrails.Create";
        public const string Pages_DocumentRequestAuditTrails_Edit = "Pages.DocumentRequestAuditTrails.Edit";
        public const string Pages_DocumentRequestAuditTrails_Delete = "Pages.DocumentRequestAuditTrails.Delete";

        public const string Pages_DocumentRequests = "Pages.DocumentRequests";
        public const string Pages_DocumentRequests_Create = "Pages.DocumentRequests.Create";
        public const string Pages_DocumentRequests_Edit = "Pages.DocumentRequests.Edit";
        public const string Pages_DocumentRequests_Delete = "Pages.DocumentRequests.Delete";
