...
namespace BTIT.EPM.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : EPMServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("BTIT.EPM", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
