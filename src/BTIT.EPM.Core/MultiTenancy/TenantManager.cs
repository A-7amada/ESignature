...
using BTIT.EPM.MultiTenancy.Demo;
...
namespace BTIT.EPM.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(EPMConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(EPMConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
