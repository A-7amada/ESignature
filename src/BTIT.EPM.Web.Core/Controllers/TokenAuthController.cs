...
using BTIT.EPM.Web.Authentication.JwtBearer;
using BTIT.EPM.Web.Authentication.TwoFactor;
using BTIT.EPM.Web.Models.TokenAuth;
...
namespace BTIT.EPM.Web.Controllers
{
    ...
    public class TokenAuthController : EPMControllerBase
    {
