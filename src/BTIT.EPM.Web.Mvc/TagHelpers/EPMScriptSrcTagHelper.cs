...
namespace BTIT.EPM.Web.TagHelpers
{
    [HtmlTargetElement("script", Attributes = AbpSrcAttributeName)]
    public class EPMScriptSrcTagHelper : TagHelper
    {
        ...
        public EPMScriptSrcTagHelper(IWebHostEnvironment hostingEnvironment, IHttpContextAccessor httpContextAccessor)
        {
