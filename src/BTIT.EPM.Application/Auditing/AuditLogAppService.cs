...
using BTIT.EPM.Auditing.Exporting;
using BTIT.EPM.Authorization;
using BTIT.EPM.Authorization.Users;
using BTIT.EPM.Dto;
using BTIT.EPM.EntityHistory;
using EntityHistoryHelper = BTIT.EPM.EntityHistory.EntityHistoryHelper;

namespace BTIT.EPM.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : EPMAppServiceBase, IAuditLogAppService
    {
