...
using BTIT.EPM.Migrations.Seed;
...
namespace BTIT.EPM.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : EPMAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<EPMDbContext> _migrator;
