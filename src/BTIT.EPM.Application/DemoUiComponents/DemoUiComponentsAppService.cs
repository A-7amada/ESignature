...
using BTIT.EPM.DemoUiComponents.Dto;

namespace BTIT.EPM.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : EPMAppServiceBase, IDemoUiComponentsAppService
    {
