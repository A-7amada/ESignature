...
{
    public class SessionAppService : EPMAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = EPMConsts.Currency,
                    CurrencySign = EPMConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = EPMConsts.AllowTenantsToChangeEmailSettings,
