...
using BTIT.EPM.Authorization.Users.Exporting;
using BTIT.EPM.Dto;
...
namespace BTIT.EPM.Authorization.Users
{
    ...
    public class UserAppService : EPMAppServiceBase, IUserAppService
    {
        ...
        public async Task<List<DropDownListDto>> GetUsersForDropDown()
        {
            var users = await _usersRepository.GetAll()
                                             .Select(x => new DropDownListDto
                                             {
                                                 Id = x.Id,
                                                 Text = x.Name
                                             }).ToListAsync();
