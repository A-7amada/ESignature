...
namespace BTIT.EPM.Migrations
{
    ...
    [Migration("20220531110515_Added_FileSignature")]
    partial class Added_FileSignature
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BTIT.EPM.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("BTIT.EPM.DigitalSignature.Contact", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("BTIT.EPM.DigitalSignature.DocumentRequest", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<bool>("IsSigningOrdered")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("BTIT.EPM.DigitalSignature.DocumentRequestAuditTrail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("DocumentRequestAuditTrails");
                });

            modelBuilder.Entity("BTIT.EPM.DigitalSignature.Recipient", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<int>("SigneOrder")
                        .HasColumnType("int");

                    b.Property<string>("SignerPin")
                        .HasColumnType("nvarchar(100)")
                        .HasMaxLength(100);

                    b.Property<DateTime?>("SignerPinExpiry")
                        .HasColumnType("datetime2");

                    b.Property<short?>("SignerPinTriesCount")
                        .HasColumnType("smallint");
            ...
            modelBuilder.Entity("BTIT.EPM.Documents.Document", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("BTIT.EPM.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("BTIT.EPM.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("BTIT.EPM.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("BTIT.EPM.DigitalSignature.DocumentRequestAuditTrail", b =>
                {
                    b.HasOne("BTIT.EPM.DigitalSignature.DocumentRequest", "DocumentRequestFk")
                        .WithMany("DocumentRequestAuditTrails")
                        .HasForeignKey("DocumentRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BTIT.EPM.DigitalSignature.Recipient", "RecipientFk")
                        .WithMany()
            ...
            modelBuilder.Entity("BTIT.EPM.DigitalSignature.Recipient", b =>
                {
                    ...
                    b.HasOne("BTIT.EPM.Authorization.Users.User", "UserFk")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
