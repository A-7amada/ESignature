...
{
    public class SubscriptionPaymentRepository : EPMRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<EPMDbContext> dbContextProvider)
