...
using BTIT.EPM.Core.Base;
using BTIT.EPM.Core.Extensions;
using BTIT.EPM.Dto;
using BTIT.EPM.Types;

namespace BTIT.EPM.Queries
{
    public class OrganizationUnitQuery : EPMQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
